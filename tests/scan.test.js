...
function setup(initial=[]) {
  ...
  vm.runInNewContext(code,{chrome,document:{documentElement:{},querySelectorAll:()=>[video],addEventListener:(name,fn)=>events[name]=fn},
  ...
  return {messages,events,observers,video,timers,flush(){const tasks=[...timers.values()];timers.clear();tasks.forEach(fn=>fn());}};
}
